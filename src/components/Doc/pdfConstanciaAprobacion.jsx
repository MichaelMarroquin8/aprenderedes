...
const pdfConstanciaGerente = () => {
  ...
  addCenteredBoldTitle(
    "EL SUSCRITO GERENTE DE LA COOPERATIVA __________________(Indicar la razón social)",
    12
  );
  cursorY += 30;
  ...
  addJustifiedText(
    `Que el Estatuto, contiene las previsiones de la Ley 79 de 1988, el cual se encuentra firmado por el Presidente y Secretario de la Asamblea, realizada en reunión celebrada el día _____ de ___________ de __________`
  );
  cursorY += 7;
  ...
  addJustifiedText(
    `Ciudad __________ Se firma a los ______ días del mes de __________ de __________`
  );
