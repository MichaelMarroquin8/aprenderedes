...
const pdfConstanciaGerente = () => {
  ...
  cursorY += 25;
  addSubtitle("_______________________(Indicar la razón social)", 12);
  cursorY += 25;
  ...
  addJustifiedText(
    `Que los asociados fundadores de la Cooperativa ___________, han cancelado cada uno la suma de ____________ MIL PESOS (_______) M/CTE, como aporte social inicial suscrito y pagado, de conformidad con lo establecido en los estatutos.`
  );

  cursorY += 25;

  addJustifiedText(`Fecha, Ciudad__________________.`);
